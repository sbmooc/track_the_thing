# Generated by Django 2.2.2 on 2019-06-06 06:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('payment_in', 'Payment In'), ('payment_out', 'Payment Out'), ('start_race', 'Start Race'), ('finish_race', 'Finish Race'), ('scratch', 'Scratch'), ('arrive_checkpoint', 'Arrive Checkpoint'), ('tracker_assigned', 'Tracker Assigned'), ('tracker_remove_assignment', 'Tracker remove assignment'), ('tracker_add_possession', 'Tracker Possession Add'), ('tracker_remove_possession', 'Tracker Possession Remove')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rider_assigned', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assigned_trackers', to='tracker.Riders')),
                ('rider_possess', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='current_tracker', to='tracker.Riders')),
            ],
        ),
        migrations.CreateModel(
            name='TrackerNotes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('events', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notes', to='tracker.RiderEvents')),
